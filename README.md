...
This project was completed as part of the **JPMorgan Chase & Co. Advanced Software Engineering Virtual Experience Program** on **Forage**.

During this simulation, I completed hands-on software engineering tasks including:

- Project setup and Spring Boot configuration
- Apache Kafka consumer implementation
- H2 database integration and transaction processing
- External REST API integration
- RESTful API development for balance queries

This repository showcases my completed solution and demonstrates practical experience with event-driven microservices, backend development, and financial transaction processing.
